...
var utils = {
    ...
    vertical_center_align_gravatar: function( $el ) {
        var usermsg_length = $el.find('.message-height').length,
            ...
            gravatar_length = $el.find( '.vertical-align' ).length,
            gravatar_height = ( $( $el.find( '.vertical-align img' )[ gravatar_length - 1 ] ).height() / 2 );
        $( $el.find( '.vertical-align img' )[ gravatar_length - 1 ] ).css( 'padding-top', usermsg_height - gravatar_height );
    },
