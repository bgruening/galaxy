...
FLUENT_IMPORT_MESSAGE = (
    "The Python fluent package is required to use this " "feature, please install it"
)
...
class FluentTraceLogger(object):
    ...
    def log(self, label, event_time=None, **kwargs):
        ...
        self.sender.emit_with_time(
            label, int(event_time), json.dumps(kwargs, default=str)
        )
