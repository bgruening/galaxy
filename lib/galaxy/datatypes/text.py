    ...
    def display_data(
        ...
        if trust:
            return self._display_data_trusted(
                trans, dataset, preview=preview, filename=filename, to_ext=to_ext, **kwd
            )
        else:
...
class SnpSiftDbNSFP(Text):
    ...
    def generate_primary_file(self, dataset=None):
        ...
        """
        return (
            "<html><head><title>SnpSiftDbNSFP Composite Dataset</title></head></html>"
        )
