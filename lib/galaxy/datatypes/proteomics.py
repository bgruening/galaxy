...
class SPLib(Msp):
    ...
    def sniff_prefix(self, file_prefix):
        ...
        return Msp.next_line_starts_with(
            contents, "Name:"
        ) and Msp.next_line_starts_with(contents, "LibID:")
...
class ImzML(Binary):
    ...
    def __init__(self, **kwd):
        ...
        """The metadata"""
        self.add_composite_file(
            "imzml", description="The imzML metadata component.", is_binary=False
        )

        """The mass spectral data"""
        self.add_composite_file(
            "ibd", description="The mass spectral data component.", is_binary=True
        )
