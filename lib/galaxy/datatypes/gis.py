...
class Shapefile(Binary):
    ...
    def __init__(self, **kwd):
        ...
        self.add_composite_file(
            "shapefile.shp",
            description="Geometry File (shp)",
            is_binary=True,
            optional=False,
        )
        self.add_composite_file(
            "shapefile.shx",
            description="Geometry index File (shx)",
            is_binary=True,
            optional=False,
        )
        self.add_composite_file(
            "shapefile.dbf",
            description="Columnar attributes for each shape (dbf)",
            is_binary=True,
            optional=False,
        )
        # optional
        self.add_composite_file(
            "shapefile.prj",
            description="Projection description (prj)",
            is_binary=False,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.sbn",
            description="Spatial index of the features (sbn)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.sbx",
            description="Spatial index of the features (sbx)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.fbn",
            description="Read only spatial index of the features (fbn)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.fbx",
            description="Read only spatial index of the features (fbx)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
        ...
        self.add_composite_file(
            "shapefile.atx",
            description="Attribute index for the dbf file (atx)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.ixs",
            description="Geocoding index (ixs)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.mxs",
            description="Geocoding index in ODB format (mxs)",
            is_binary=True,
            optional=True,
        )
        self.add_composite_file(
            "shapefile.shp.xml",
            description="Geospatial metadata in XML format (xml)",
            is_binary=False,
            optional=True,
        )
