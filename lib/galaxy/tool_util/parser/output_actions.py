...
class ToolOutputActionConditionalWhen(ToolOutputActionGroup):
    ...
    def get_ref(self, output_dataset, other_values):
        ...
        for ref_name in self.parent.name:
            assert ref_name in ref, (
                "Required dependency '%s' not found in incoming values" % ref_name
            )
...
class DatatypeIsInstanceToolOutputActionConditionalWhen(
    ...
    def __init__(self, parent, config_elem, value):
        super(DatatypeIsInstanceToolOutputActionConditionalWhen, self).__init__(
            parent, config_elem, value
        )
        self.value = type(
...
class ToolOutputActionConditional(object):
    ...
    def __init__(self, parent, config_elem):
        ...
        ), "Required 'name' attribute missing from ToolOutputActionConditional"
...
class ToolOutputAction(object):
    ...
    def from_elem(cls, parent, elem):
        ...
        ), "Required 'type' attribute missing from ToolOutputAction"
...
class ToolOutputActionOption(object):
    ...
    def from_elem(cls, parent, elem):
        ...
        ), "Required 'type' attribute missing from ToolOutputActionOption"
...
class FromFileToolOutputActionOption(ToolOutputActionOption):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.name is not None
        ), "Required 'name' attribute missing from FromFileToolOutputActionOption"
        self.column = elem.get("column", None)
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from FromFileToolOutputActionOption"
...
class FromDataTableOutputActionOption(ToolOutputActionOption):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.name is not None
        ), "Required 'name' attribute missing from FromDataTableOutputActionOption"
        ...
        if self.name in self.tool.app.tool_data_tables:
            ...
            assert (
                self.column is not None
            ), "Required 'column' attribute missing from FromDataTableOutputActionOption"
            self.column = int(self.column)
            self.offset = elem.get("offset", -1)
            self.offset = int(self.offset)
        else:
...
class MetadataToolOutputAction(ToolOutputAction):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.name is not None
        ), "Required 'name' attribute missing from MetadataToolOutputAction"
...
class ToolOutputActionOptionFilter(object):
    ...
    def from_elem(cls, parent, elem):
        ...
        ), "Required 'type' attribute missing from ToolOutputActionOptionFilter"
...
class MultipleSplitterFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from MultipleSplitterFilter"
        self.column = int(self.column)
        self.separator = elem.get("separator", ",")
    ...
    def filter_options(self, options, other_values):
        ...
        for fields in options:
            for field in fields[self.column].split(self.separator):
                rval.append(
                    fields[0 : self.column] + [field] + fields[self.column + 1 :]
                )
        return rval
...
class ColumnStripFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from ColumnStripFilter"
        self.column = int(self.column)
...
class ColumnReplaceFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        assert bool(self.old_column) ^ bool(self.old_value) and bool(
            self.new_column
        ) ^ bool(
            self.new_value
        ...
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from ColumnReplaceFilter"
        self.column = int(self.column)
...
class MetadataValueFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        ), "Required 'ref' attribute missing from MetadataValueFilter"
        self.ref = self.ref.split(".")
        self.name = elem.get("name", None)
        assert (
            self.name is not None
        ), "Required 'name' attribute missing from MetadataValueFilter"
        self.column = elem.get("column", None)
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from MetadataValueFilter"
        self.column = int(self.column)
        self.keep = util.string_as_bool(elem.get("keep", "True"))
        self.compare = parse_compare_type(elem.get("compare", None))
...
class BooleanFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from BooleanFilter"
        self.column = int(self.column)
        self.keep = util.string_as_bool(elem.get("keep", "True"))
        self.cast = parse_cast_attribute(elem.get("cast", None))
...
class StringFunctionFilter(ToolOutputActionOptionFilter):
    ...
    def __init__(self, parent, elem):
        ...
        assert (
            self.column is not None
        ), "Required 'column' attribute missing from StringFunctionFilter"
        self.column = int(self.column)
        ...
        assert self.function in [
            ...
            "Required function 'name' missing or invalid from StringFunctionFilter"
        )  # add function names as needed
