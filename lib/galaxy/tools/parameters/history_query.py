...
class HistoryQuery(object):
    ...
    def __init__(self, **kwargs):
        self.collection_type_descriptions = kwargs.get(
    ...
    def from_collection_types(collection_types, collection_type_descriptions):
        if collection_types:
            collection_type_descriptions = [
                collection_type_descriptions.for_collection_type(t)
            ...
            collection_type_descriptions = sorted(
                collection_type_descriptions, key=lambda t: t.dimension, reverse=True
            )
        else:
            collection_type_descriptions = None
    ...
    def from_parameter(param, collection_type_descriptions):
        ...
        return HistoryQuery.from_collection_types(
            collection_types, collection_type_descriptions
        )
    ...
    def direct_match(self, hdca):
        ...
        if collection_type_descriptions is not None:
            for collection_type_description in collection_type_descriptions:
                if collection_type_description.can_match_type(
    ...
    def can_map_over(self, hdca):
        ...
        for collection_type_description in collection_type_descriptions:
            ...
            if collection_type_description.is_subcollection_of_type(
                hdca_collection_type
            ):
