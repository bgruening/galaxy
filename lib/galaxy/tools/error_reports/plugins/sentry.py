    ...
    def __init__(self, **kwargs):
        ...
        if self.custom_dsn:
            ...
            self.sentry = raven.Client(
                self.custom_dsn, transport=raven.transport.HTTPTransport
            )
        ...
        if self.sentry:
            ...
            if self.redact_user_details_in_bugreport:
                ...
                if user:
                    ...
                    context["user"] = {"name": user.username, "email": user.email}
            ...
            response = self.sentry_client.capture(
                ...
                tags={"tool_id": job.tool_id, "tool_version": job.tool_version},
                extra=extra,
