...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Adding column 'extended_metadata_id' to library_dataset_dataset_association table failed."
        )
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping 'extended_metadata_id' column from library_dataset_dataset_association table failed."
        )
    try:
