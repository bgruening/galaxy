...
def upgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Creating history_dataset_association_annotation_association table failed."
        )
    ...
    haaa = Index(
        ...
        HistoryAnnotationAssociation_table.c.annotation,
        mysql_length=200,
    )
    hdaaa = Index(
        "ix_history_dataset_anno_assoc_annotation",
        HistoryDatasetAssociationAnnotationAssociation_table.c.annotation,
        mysql_length=200,
    )
    swaaa = Index(
        "ix_stored_workflow_ann_assoc_annotation",
        StoredWorkflowAnnotationAssociation_table.c.annotation,
        mysql_length=200,
    )
    wsaaa = Index(
        "ix_workflow_step_ann_assoc_annotation",
        WorkflowStepAnnotationAssociation_table.c.annotation,
        mysql_length=200,
    )
...
def downgrade(migrate_engine):
    ...
    try:
        ...
        log.exception(
            "Dropping history_dataset_association_annotation_association table failed."
        )
