...
StoredWorkflowTagAssociation_table = Table(
...
WorkflowTagAssociation_table = Table(
...
def upgrade(migrate_engine):
    ...
    add_column(
        ...
        metadata,
        index_name="ix_history_tag_association_user_id",
    )
    ...
    add_column(
        ...
        metadata,
        index_name="ix_history_dataset_association_tag_association_user_id",
    )
    ...
    add_column(
        ...
        metadata,
        index_name="ix_page_tag_association_user_id",
    )
