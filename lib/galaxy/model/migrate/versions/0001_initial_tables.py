...
ImplicitlyConvertedDatasetAssociation_table = Table(
...
JobToInputDatasetAssociation_table = Table(
...
JobToOutputDatasetAssociation_table = Table(
...
GalaxySessionToHistoryAssociation_table = Table(
...
StoredWorkflowUserShareAssociation_table = Table(
...
StoredWorkflowMenuEntry_table = Table(
