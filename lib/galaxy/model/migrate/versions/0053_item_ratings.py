...
# Rating tables.
HistoryRatingAssociation_table = Table(
...
HistoryDatasetAssociationRatingAssociation_table = Table(
...
StoredWorkflowRatingAssociation_table = Table(
...
PageRatingAssociation_table = Table(
...
VisualizationRatingAssociation_table = Table(
...
def upgrade(migrate_engine):
    ...
    try:
        ...
        if migrate_engine.name == "mysql" and str(e).lower().find(
            "identifier name 'ix_history_dataset_association_rating_association_history_dataset_association_id' is too long"
        ):
            add_index(
                "ix_hda_rating_association_hda_id",
