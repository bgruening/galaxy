...
HistoryDatasetCollectionAssociation_table = Table(
...
DatasetCollectionElement_table = Table(
...
HistoryDatasetCollectionAnnotationAssociation_table = Table(
...
LibraryDatasetCollectionAnnotationAssociation_table = Table(
...
HistoryDatasetCollectionRatingAssociation_table = Table(
...
LibraryDatasetCollectionRatingAssociation_table = Table(
...
HistoryDatasetCollectionTagAssociation_table = Table(
...
LibraryDatasetCollectionTagAssociation_table = Table(
...
JobToInputDatasetCollectionAssociation_table = Table(
...
JobToOutputDatasetCollectionAssociation_table = Table(
...
ImplicitlyCreatedDatasetCollectionInput_table = Table(
...
HiddenBeneathCollection_column = Column(
...
def downgrade(migrate_engine):
    ...
    try:
        hda_table = Table("history_dataset_association", metadata, autoload=True)
        hidden_beneath_collection_instance_id_col = (
            hda_table.c.hidden_beneath_collection_instance_id
        )
