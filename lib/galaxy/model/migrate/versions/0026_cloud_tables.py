...
UCI_table = Table(
    ...
    Column(
        "credentials_id", Integer, ForeignKey("cloud_user_credentials.id"), index=True
    ),
...
CloudSnapshot_table = Table(
    ...
    Column("uci_id", Integer, ForeignKey("cloud_uci.id"), index=True),
    Column(
        "store_id", Integer, ForeignKey("cloud_store.id"), index=True, nullable=False
    ),
...
CloudUserCredentials_table = Table(
