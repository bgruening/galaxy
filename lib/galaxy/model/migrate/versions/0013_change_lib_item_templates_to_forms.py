...
def upgrade(migrate_engine):
    ...
    try:
        LibraryItemInfoPermissions_table = Table(
            "library_item_info_permissions", metadata, autoload=True
        )
    ...
    try:
        LibraryItemInfoTemplatePermissions_table = Table(
            "library_item_info_template_permissions", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryItemInfoElement_table = Table(
            "library_item_info_element", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryItemInfoTemplateElement_table = Table(
            "library_item_info_template_element", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryInfoTemplateAssociation_table = Table(
            "library_info_template_association", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryFolderInfoTemplateAssociation_table = Table(
            "library_folder_info_template_association", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryDatasetInfoTemplateAssociation_table = Table(
            "library_dataset_info_template_association", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        ...
        log.debug(
            "Failed loading table library_dataset_dataset_info_template_association"
        )
    try:
    ...
    try:
        LibraryInfoAssociation_table = Table(
            "library_info_association", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryDatasetInfoAssociation_table = Table(
            "library_dataset_info_association", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    try:
        LibraryItemInfoTemplate_table = Table(
            "library_item_info_template", metadata, autoload=True
        )
    except NoSuchTableError:
    ...
    if migrate_engine.name == "mysql":
        ...
        try:
            ...
            log.exception(
                "Adding index 'ix_lddaia_ldda_id' to table 'library_dataset_dataset_info_association' table failed."
            )
