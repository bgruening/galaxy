...
class FolderManager(object):
    ...
    def get(
        self, trans, decoded_folder_id, check_manageable=False, check_accessible=True
    ):
        """
    ...
    def check_manageable(self, trans, folder):
        ...
        if not trans.app.security_agent.can_manage_library_item(
            ...
            raise InsufficientPermissionsException(
                "You don't have permissions to manage this folder.", type="error"
            )
        else:
            return folder
    ...
    def create(
        self, trans, parent_folder_id, new_folder_name, new_folder_description=""
    ):
        """
