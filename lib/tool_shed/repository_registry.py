...
class Registry(object):
    def __init__(self, app):
        ...
        self.certified_level_one_clause_list = (
            self.get_certified_level_one_clause_list()
        )
    ...
    def add_category_entry(self, category):
        ...
        if (
            category_name
            not in self.certified_level_one_viewable_repositories_and_suites_by_category
        ):
            self.certified_level_one_viewable_repositories_and_suites_by_category[
                category_name
            ] = 0
    ...
    def add_entry(self, repository):
        try:
            if repository:
                ...
                certified_level_one_tuple = self.get_certified_level_one_tuple(
                    repository
                )
                latest_installable_changeset_revision, is_level_one_certified = (
                    certified_level_one_tuple
                )
                for rca in repository.categories:
                    ...
                    if (
                        category_name
                        in self.viewable_repositories_and_suites_by_category
                    ):
                        self.viewable_repositories_and_suites_by_category[
                            category_name
                        ] += 1
                    ...
                    if is_valid:
                        if (
                            category_name
                            in self.viewable_valid_repositories_and_suites_by_category
                        ):
                            self.viewable_valid_repositories_and_suites_by_category[
                                category_name
                            ] += 1
                    ...
                    if is_level_one_certified:
                        if (
                            category_name
                            in self.certified_level_one_viewable_repositories_and_suites_by_category
                        ):
                            self.certified_level_one_viewable_repositories_and_suites_by_category[
                                category_name
                            ] += 1
                        ...
                        if repository.type == rt_util.REPOSITORY_SUITE_DEFINITION:
                            if (
                                category_name
                                in self.certified_level_one_viewable_suites_by_category
                            ):
                                self.certified_level_one_viewable_suites_by_category[
                                    category_name
                                ] += 1
    ...
    def edit_category_entry(self, old_name, new_name):
        ...
        if (
            ...
            del self.certified_level_one_viewable_repositories_and_suites_by_category[
                old_name
            ]
            self.certified_level_one_viewable_repositories_and_suites_by_category[
                new_name
    ...
    def get_certified_level_one_tuple(self, repository):
        ...
        if latest_installable_changeset_revision not in [
            None,
            hg_util.INITIAL_CHANGELOG_HASH,
        ]:
    ...
    def is_valid(self, repository):
        if (
            ...
            and not repository.deprecated
            and repository.downloadable_revisions
        ):
            return True
        return False
    ...
    def load_certified_level_one_repository_and_suite_tuple(self, repository):
        ...
        if tip_changeset_hash != hg_util.INITIAL_CHANGELOG_HASH:
            ...
            if repository.type == rt_util.REPOSITORY_SUITE_DEFINITION:
                if (
                    certified_level_one_tuple
                    not in self.certified_level_one_suite_tuples
                ):
                    self.certified_level_one_suite_tuples.append(
                        certified_level_one_tuple
                    )
            else:
                if (
                    certified_level_one_tuple
                    not in self.certified_level_one_repository_and_suite_tuples
                ):
                    self.certified_level_one_repository_and_suite_tuples.append(
                        certified_level_one_tuple
                    )
    ...
    def remove_entry(self, repository):
        try:
            if repository:
                ...
                if is_level_one_certified:
                    self.unload_certified_level_one_repository_and_suite_tuple(
                        repository
                    )
        except Exception:
            # The viewable repository numbers and the categorized (filtered) lists of repository tuples
        ...
        if tip_changeset_hash != hg_util.INITIAL_CHANGELOG_HASH:
            ...
            if repository.type == rt_util.REPOSITORY_SUITE_DEFINITION:
                if certified_level_one_tuple in self.certified_level_one_suite_tuples:
                    self.certified_level_one_suite_tuples.remove(
                        certified_level_one_tuple
                    )
            else:
                if (
                    certified_level_one_tuple
                    in self.certified_level_one_repository_and_suite_tuples
                ):
                    self.certified_level_one_repository_and_suite_tuples.remove(
                        certified_level_one_tuple
                    )
