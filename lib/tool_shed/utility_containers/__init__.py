...
class RepositorySuccessfulInstallation(object):
    ...
    def __init__(
        self, id=None, tool_shed=None, name=None, owner=None, changeset_revision=None
    ):
        self.id = id
        self.tool_shed = tool_shed
        self.name = name
...
class ToolDependencySuccessfulInstallation(object):
    ...
    def __init__(
        self, id=None, type=None, name=None, version=None, installation_directory=None
    ):
        self.id = id
        self.type = type
        self.name = name
...
class ToolShedUtilityContainerManager(
    utility_container_manager.UtilityContainerManager
):
        ...
        if invalid_repository_dependencies_dict:
            ...
            for invalid_repository_dependency in invalid_repository_dependencies:
                ...
                toolshed, name, owner, changeset_revision, prior_installation_required, only_if_compiling_contained_td, error = common_util.parse_repository_dependency_tuple(
                    invalid_repository_dependency, contains_error=True
                )
    ...
    def build_invalid_tool_dependencies_root_folder(
        self, folder_id, invalid_tool_dependencies_dict
    ):
        ...
        if invalid_tool_dependencies_dict:
            ...
            invalid_tool_dependencies_root_folder.folders.append(
            ...
            for td_key, requirements_dict in invalid_tool_dependencies_dict.items():
                ...
                label = "Version <b>%s</b> of the <b>%s</b> <b>%s</b>" % (
                    version,
                    name,
                    type,
                )
            ...
            try:
                ...
                if metadata:
                    if (
                        ...
                        folder_id, invalid_repository_dependencies_root_folder = self.build_invalid_repository_dependencies_root_folder(
                ...
                if metadata:
                    if (
                        "invalid_tool_dependencies" not in exclude
                        and "invalid_tool_dependencies" in metadata
                    ):
                        invalid_tool_dependencies = metadata[
                            "invalid_tool_dependencies"
                        ]
                        folder_id, invalid_tool_dependencies_root_folder = self.build_invalid_tool_dependencies_root_folder(
                            folder_id, invalid_tool_dependencies
                        )
                        containers_dict[
                            "invalid_tool_dependencies"
                ...
                if metadata:
                    if (
                        "tool_dependencies" not in exclude
