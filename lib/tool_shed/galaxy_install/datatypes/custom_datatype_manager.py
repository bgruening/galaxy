...
class CustomDatatypeLoader(object):
    ...
    def load_installed_datatype_converters(
        self, installed_repository_dict, deactivate=False
    ):
    ...
    def load_installed_datatypes(
        self, repository, relative_install_dir, deactivate=False
    ):
        """
    ...
    def load_installed_display_applications(
        self, installed_repository_dict, deactivate=False
    ):
